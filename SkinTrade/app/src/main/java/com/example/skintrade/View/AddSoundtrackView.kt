...
@Composable
fun AddSoundtrackView(viewModel: SharedViewModel, onBackClicked: () -> Unit) {
    ...
    Column(modifier = Modifier.fillMaxSize().padding(16.dp)) {
        Text("Agregar Soundtrack", fontSize = 24.sp)
        ...
        Button(onClick = {
            ...
            viewModel.addProduct(newSoundtrack)
            onBackClicked()
        }) {
            Text("Guardar Soundtrack")
        }
